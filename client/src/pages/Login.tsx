    ...
    <div className="flex flex-col items-center h-full bg-[] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <form className="mt-8" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            <button type="submit" className="group relative w-full flex justify-center py-2 px-4 text-sm leading-5 font-medium text-[#CB3737] border-2 rounded-full border-[#CB3737] hover:shadow-2xl">
              Sign in
            </button>
          </div>
        </form>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-600">
            New user?{" "}
            <Link to="/register" className="font-medium text-[#CB3737] hover:underline">
              Create an account
            </Link>
          </p>
        </div>
